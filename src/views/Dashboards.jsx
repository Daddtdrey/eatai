                                            ...
                                            {groupItems(order.items).map((item, idx) => (
                                                <div key={idx} className="flex justify-between py-1 border-b border-gray-200 dark:border-gray-700 last:border-0">
                                                    <div>
                                                        ...
                                                        {item.selectedAddons && item.selectedAddons.length > 0 && <span className="block text-[10px] text-orange-600 font-bold">+ {item.selectedAddons.map(a => `${a.name} (₦${a.price})`).join(', ')}</span>}
                                                        {item.selectedSide && <span className="block text-[10px] text-orange-600 font-bold">+ {item.selectedSide} (₦{item.sidePrice})</span>}
